package net.morimori.simpletranslation.translation;

import com.google.gson.JsonObject;
import net.morimori.simpletranslation.exception.TranslationException;
import net.morimori.simpletranslation.util.URLUtils;
